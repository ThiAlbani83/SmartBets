...
const SigapUploadFile = () => {
  ...
  // Simulated data loading effect similar to Antifraude.jsx
  useEffect(() => {
    setIsLoading(true);
    ...
    <div className="p-6 max-w-8xl w-full">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          ...
          <label className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 transition-colors px-6 py-2 rounded-lg shadow-sm text-white cursor-pointer">
        ...
        {/* Status Indicator */}
        {isUploading && (
          <div className="w-full bg-blue-50 text-blue-700 p-3 rounded-lg mb-4 flex items-center justify-center">
            <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-blue-700 mr-3"></div>
            <span>Enviando arquivo, por favor aguarde...</span>
          </div>
        )}
      </div>
