    ...
    <>
      <div className="mx-auto px-4 py-8 flex flex-col">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button
              ...
              onClick={() => {
                alert("Abrindo agendamento de monitoramento...");
              }}
            >
            ...
            <button
              ...
              onClick={() => {
                alert("Enviando notificações para empresas...");
              }}
            >
              Notificar Empresas
            </button>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
          ...
          <thead className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="border-l-4 border-blue-500 pl-4 py-2">
              <h3 className="font-medium text-gray-900 mb-1">
                Tendência de Violações
              </h3>
              <p className="text-sm text-gray-600">
                Observamos um aumento de{" "}
                {Math.round(
                  (systemStats.tendenciaViolacoes[4].quantidade /
                    systemStats.tendenciaViolacoes[0].quantidade -
                    1) *
                    100
                )}
                % nas violações desde janeiro. Recomendamos intensificar o
                monitoramento e realizar treinamentos com as equipes de
                marketing das empresas.
              </p>
            </div>
            <div className="border-l-4 border-green-500 pl-4 py-2">
              <h3 className="font-medium text-gray-900 mb-1">
                Redes Sociais Críticas
              </h3>
              <p className="text-sm text-gray-600">
                O Instagram concentra{" "}
                {systemStats.redesMaisMonitoradas[0].percentual}% das violações
                detectadas. Sugerimos focar os esforços de monitoramento nesta
                plataforma e estabelecer diretrizes específicas.
              </p>
            </div>
          </thead>
        </div>
